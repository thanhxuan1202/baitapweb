...
//        => optionsBuilder.UseSqlServer("Server=ADMIN-PC\\XUAN;Database=K64CNTT1DB;uid=sa;pwd=1234$;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CtHoaDon>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__CT_HOA_D__3214EC27BE223BC7");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HOA_DON__3214EC27374BFB83");

            entity.ToTable("HOA_DON");

            entity.HasIndex(e => e.MaHoaDon, "UQ__HOA_DON__835ED13A90F81604").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__KHACH_HA__3214EC27E053D7B9");

            entity.ToTable("KHACH_HANG");

            entity.HasIndex(e => e.DienThoai, "UQ__KHACH_HA__1F031876FBE3CAD7").IsUnique();

            entity.HasIndex(e => e.MaKhachHang, "UQ__KHACH_HA__88D2F0E4D7575681").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__KHACH_HA__A9D10534E0CE2B61").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LOAI_SAN__3214EC27FAA447E5");

            entity.ToTable("LOAI_SAN_PHAM");

            entity.HasIndex(e => e.MaLoai, "UQ__LOAI_SAN__730A5758315B01DF").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__QUAN_TRI__3214EC27D53C4A1B");

            entity.ToTable("QUAN_TRI");

            entity.HasIndex(e => e.TaiKhoan, "UQ__QUAN_TRI__D5B8C7F0D39F89EC").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SAN_PHAM__3214EC2741781C27");

            entity.ToTable("SAN_PHAM");

            entity.HasIndex(e => e.MaSanPham, "UQ__SAN_PHAM__FAC7442CF6C32D0F").IsUnique();
